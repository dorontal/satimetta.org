	...
	<details class="group p-2">
		...
		<div class="p-group">
			...
			<p>
				...
				state - allowing the mind to settle and the heart to open to deeper spiritual experiences.
			</p>
		</div>
	</details>
	<hr class="hr" />
	...
	<details class="group p-2">
		...
		<div class="p-group">
			<p>
				...
				if we had rushed to address them and skipped meditation instead.
			</p>
		</div>
	</details>
	<hr class="hr" />
