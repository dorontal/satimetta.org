import{J as e,P as t,R as n,S as r,c as i,n as a,p as o,q as s,rt as c,w as l}from"../chunks/BwfJX2nj.js";import"../chunks/xihTtKlq.js";import"../chunks/B0AryO89.js";var u=c({csr:()=>!0,prerender:()=>!0}),d=l(`<meta name="description" content="Mindfulness Questions and Answers / Mindfulness Q&amp;A / Mindfulness Q &amp; A/ Mindfulness Frequently Asked Questions / Mindfulness FAQ"/>`),f=l(`<div class="text-column"><details class="group p-2" id="definition-of-mindfulness"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the definition of mindfulness?</span></summary> <div class="p-group"><p>A simple, high level, definition of mindfuness is "remembering to be aware", or "connecting
				...
				with presence and ease. It's a gradual training, and you're already in it.</p></div></details></div>`);function p(c,l){e(l,!1),a(()=>{let e=window.location.hash.slice(1);if(!e)return;let t=document.getElementById(e);t instanceof HTMLDetailsElement&&(t.open=!0,t.scrollIntoView())}),i();var u=f();o(`g1dj59`,e=>{var i=d();t(()=>{n.title=`Mindfulness Questions and Answers`}),r(e,i)}),r(c,u),s()}export{p as component,u as universal};