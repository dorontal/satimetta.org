import{P as e,R as t,S as n,X as r,Y as i,at as a,c as o,n as s,p as c,w as l}from"../chunks/BtFrpGV8.js";import"../chunks/xihTtKlq.js";import"../chunks/OuboqFDP.js";var u=a({csr:()=>!0,prerender:()=>!0}),d=l(`<meta name="description" content="Mindfulness Questions and Answers / Mindfulness Q&amp;A / Mindfulness Q &amp; A/ Mindfulness Frequently Asked Questions / Mindfulness FAQ"/>`),f=l(`<div class="text-column"><details class="group p-2" id="definition-of-mindfulness"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the definition of mindfulness?</span></summary> <div class="p-group"><p>A simple, high level, definition of mindfuness is "remembering to be aware", or "connecting
				...
				present moment, non-judgmentally”.</p> <p>The above definitions refer to mindfulness as a mental capacity. This capacity can fluctuate
				...
				to everyday activities.</p></div></details> <hr class="hr"/> <details class="group p-2" id="what-mindfulness-is-not"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What mindfulness is not</span></summary> <div class="p-group"><p>Some common misconceptions about mindfulness:</p> <p><b>Mindfulness</b> is not the same as <b>mindfulness practice</b>: <b>Mindfulness</b> is a quality of the mind (see the definition of mindfulness question,
				...
				or getting lost in daydreams.</p></div></details> <hr class="hr"/> <details class="group p-2" id="meditation-vs-mindfulness-practice"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the difference between meditation and mindfulness practice?</span></summary> <div class="p-group"><p>Meditation encompasses a variety of practices used for different purposes across the world's
				...
				formal mindfulness practice.</p> <p>However, mindfulness practice - e.g, informal mindfulness practice - can occur without
				...
				during meditation.</p></div></details> <hr class="hr"/> <details class="group p-2" id="formal-vs-informal-mindfulness-practice"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the difference between formal and informal mindfulness practice?</span></summary> <div class="p-group"><p>Formal mindfulness practice means setting aside dedicated time to focus on a specific
				...
				direction, keeping the mind open and observant of the entire experience as it unfolds.</p> <p>Open awareness is an <strong>advanced practice</strong>. For individuals with highly
				...
				important differences between the two:</p> <ul><li><b>Intention and Control</b> <p>Mindfulness involves a deliberate choice to stay in the present moment, while mind
						...
						negatively impact both mental well-being and overall brain function.</p></li></ul></div></details> <hr class="hr"/> <details class="group p-2" id="relationship-between-prayer-and-mindfulness-practice"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the relationship between prayer and mindfulness practice?</span></summary> <div class="p-group"><p>Prayer can be seen as a conversation - expressing gratitude, seeking guidance, or making
				...
				us engage with life as it unfolds - with greater clarity and acceptance.</p> <p>Mindfulness is not a religious practice and does not conflict with prayer. In fact, the two
				can complement each other. Mindfulness can make prayer more intentional by helping us be
				...
				state - allowing the mind to settle and the heart to open to deeper spiritual experiences.</p></div></details> <hr class="hr"/> <details class="group p-2" id="body-tension-during-meditation"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What to do about body tension during meditation?</span></summary> <div class="p-group"><p>It's common for tension to build in the body during meditation. Here are some brief
				suggestions for managing body tension during meditation:</p> <ul><li><b>Intentional breath reset</b> <p>Temporarily shift to intentional breathing - gently take full, long breaths, letting the
						...
						can support a more accepting and relaxed relationship with physical discomfort.</p></li></ul></div></details> <hr class="hr"/> <details class="group p-2" id="i-dont-get-mindfulness-of-breathing"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">"I just don't get this mindfulness of breathing practice."</span></summary> <div class="p-group"><p>It's completely understandable to feel like you don't 'get' breath meditation. The good news
				...
				practicing and stay curious about whatever shows up, with openness and kindness.</p> <p>Continuity of practice matters - it strengthens the mindfulness muscle and becomes
				...
				anchor at all.</p> <p>Staying relaxed throughout practice is also important - it's what makes the practice
				...
				meditation or body-scan meditation.</p> <p>It can take a long time to notice the positive changes practice brings. Some of us have a
				harder time noticing them at first, but with time they become easier to see.</p></div></details> <hr class="hr"/> <details class="group p-2" id="dealing-with-strong-thoughts-before-meditating"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">"When I get strong thoughts on my mind, should I deal with them first, before a formal
				...
				morning as soon as we wake up or every time we gather in class or with a group. Setting this
				intention ahead of time helps us stick with practice even when thoughts feel overwhelming -
				we know this is our time to put them aside, trusting that we can return to them later. If
				...
				if we had rushed to address them and skipped meditation instead.</p></div></details> <hr class="hr"/> <details class="group p-2" id="relying-on-pleasant-external-conditions-for-meditation"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">"Is it okay to rely on pleasant external conditions to support formal practice?"</span></summary> <div class="p-group"><p>In principle, one should be able to meditate in any situation - even in the middle of a
				crowded train station or a household with kids yelling, TV blaring, and phones ringing. But
				the more your senses get bombarded, the harder it is for the mind to become indistractible.</p> <p>When advice is given to meditators to accept whatever comes up without judgment - whether
				...
				they're supports.</p> <p>Even the Buddha began his meditation instructions encouraging finding useful external
				...
				true whether you're a beginner or not.</p> <p>In short: whatever you can do to make your meditation more comfortable, more pleasant, and
				last longer - go for it. Just keep an eye out for a few common pitfalls:</p> <ul><li><p><b>Don't overdo the setup.</b> If you find yourself constantly tweaking, preparing, or delaying your meditation until everything
						is perfect, it becomes a reason not to meditate.</p></li> <li><p><b>Don't get attached to your setup.</b> Eventually, you'll find yourself without your setup - when traveling, visiting family, or
				...
				with presence and ease. It's a gradual training, and you're already in it.</p></div></details></div>`);function p(a,l){r(l,!1),s(()=>{let e=window.location.hash.slice(1);if(!e)return;let t=document.getElementById(e);t instanceof HTMLDetailsElement&&(t.open=!0,t.scrollIntoView())}),o();var u=f();c(`g1dj59`,r=>{var i=d();e(()=>{t.title=`Mindfulness Questions and Answers`}),n(r,i)}),n(a,u),i()}export{p as component,u as universal};