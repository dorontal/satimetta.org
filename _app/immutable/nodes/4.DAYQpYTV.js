import{f as t,h as o,a as e}from"../chunks/Dcv8L-ml.js";import"../chunks/DTzucMES.js";import{$ as r}from"../chunks/CXy-0ad_.js";const d=!0,l=!0,f=Object.freeze(Object.defineProperty({__proto__:null,csr:d,prerender:l},Symbol.toStringTag,{value:"Module"}));var u=t('<meta name="description" content="Mindfulness Questions and Answers / Mindfulness Q&amp;A / Mindfulness Q &amp; A/ Mindfulness Frequently Asked Questions / Mindfulness FAQ"/>'),h=t(`<div class="text-column"><details class="group p-2"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden" id="definition-of-mindfulness"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the definition of mindfulness?</span></summary> <div class="p-group"><p><a class="anchor" href="https://www.mindful.org/jon-kabat-zinn-defining-mindfulness/">Jon Kabat-Zinn's definition</a>: Mindfulness is awareness that arises from paying attention on purpose, in the present
				...
				or getting lost in daydreams.</p></div></details> <hr class="hr"/> <details class="group p-2"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden" id="open-awareness-vs-single-object-focus"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the difference between focusing on a single object in meditation and practicing open
				...
				these objects of attention.</p> <p>Open awareness can also serve as a valuable <strong>preparatory step</strong> for focused (fixed
				...
				a gentle bridge toward a refined focus on a single object.</p></div></details> <hr class="hr"/> <details class="group p-2"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden" id="formal-vs-informal-mindfulness-practice"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the difference between formal and informal mindfulness practice?</span></summary> <div class="p-group"><p>Formal mindfulness practice involves intentionally setting aside time and space to focus on
				...
				informal practice it will suffer.</p> <p>Both types of practice reinforce each other: formal practice strengthens the mental capacity
				...
				important differences between the two:</p> <ul><li><b>Intention and Control</b> <p>Mindfulness involves a deliberate choice to stay in the present moment, while mind
						...
						negatively impact both mental well-being and overall brain function.</p></li></ul></div></details> <hr class="hr"/> <details class="group p-2"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden" id="meditation-vs-mindfulness-practice"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the difference between meditation and mindfulness practice?</span></summary> <div class="p-group"><p>Meditation encompasses a variety of practices used for different purposes across the world's
				...
				any moment, not just during meditation.</p></div></details> <hr class="hr"/> <details class="group p-2"><summary class="grid cursor-pointer list-none grid-cols-[1.25rem_auto] items-center marker:hidden [&amp;::-webkit-details-marker]:hidden" id="relationship-between-prayer-and-mindfulness-practice"><span class="transform transition-transform duration-200 group-open:rotate-90">⯈</span> <span class="ml-2">What's the relationship between prayer and mindfulness practice?</span></summary> <div class="p-group"><p>Prayer can be seen as a conversation - expressing gratitude, seeking guidance, or making
				...
				supports.</p> <p>Even the Buddha began his meditation instructions with external conditions: “Having gone to
				...
				with presence and ease. It's a gradual training, and you're already in it.</p></div></details></div>`);function g(n){var i=h();o(s=>{var a=u();r.title="Mindfulness Questions and Answers",e(s,a)}),e(n,i)}export{g as component,f as universal};
