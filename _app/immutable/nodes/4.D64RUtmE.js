import{d as W,D as r}from"../chunks/diamond.t5J66D6n.js";import{e as A,a as n,t as s,f as l}from"../chunks/disclose-version.C0vAKpfw.js";import{f as T,s as f,M as d}from"../chunks/runtime.DcfpXLcu.js";import{p as z,c}from"../chunks/props.CblUmsgD.js";import{A as o}from"../chunks/Icon.3DpcTTrH.js";const q=W,B=!0,Z=Object.freeze(Object.defineProperty({__proto__:null,csr:q,prerender:B},Symbol.toStringTag,{value:"Module"}));var F=s('<meta name="description" content="Mindfulness Questions and Answers / Mindfulness Q&amp;A / Mindfulness Frequently Asked Questions / Mindfulness FAQ">'),S=s(`<div><p><a href="https://www.mindful.org/jon-kabat-zinn-defining-mindfulness/">Jon Kabat-Zinn's definition</a>: Mindfulness is the awareness that arises from paying attention, on purpose, in the
					...
					is applied to everyday activities.</p></div>`),H=s(`<div><p>Some common misconceptions about mindfulness:</p> <p><b>Mindfulness</b> is not the same as <b>mindfulness practice</b>: <b>Mindfulness</b> is a quality of the mind (see the definition of mindfulness question,
					...
					or getting lost in daydreams.</p></div>`),P=s(`<div><p>In mindfulness practice, <b>open awareness</b> refers to a state of staying receptive to whatever
					arises in the present moment, without choosing a specific object to focus on. This approach
					contrasts with focusing on a single object, such as the breath, where attention remains fixed.</p> <p>With open awareness, the “object” of meditation naturally shifts as new sensations,
					thoughts, or emotions arise, allowing for a dynamic and fluid focus. The term <b>choiceless awareness</b>, coined by J. Krishnamurti, is also used to describe this practice. It emphasizes the
					lack of preference for any particular focus, keeping the mind open and observant of the
					entire experience as it unfolds.</p> <p>Open awareness is an advanced practice. For individuals with highly distractible minds or
					...
					first, e.g, via mindfulness of breathing, before switching to open awareness.</p> <p>However, open awareness can serve a valuable role as an initial <b>preparatory step</b> for
					...
					moment, creating a gentle bridge toward refined focus on a single object.</p></div>`),D=s(`<div><p>Formal mindfulness practice involves intentionally setting aside time and space to focus
					...
					well-being, but on its own may not lead to real progress. Formal practice provides depth
					and continuity that strengthen informal mindfulness and make it more effective throughout
					the day.</p> <p>Formal practice has (much) greater potential to bring the mind to deeper states of
					collectedness, indistractibility and tranquility, which can lead to greater insight and
					enhanced mind training.</p> <p>Both types of practice reinforce each other: formal practice strengthens the mental
					...
					and allows it to go deeper.</p> <p>Steady progress requires both formal and informal practice; neither alone is sufficient.</p></div>`),O=s(`<div><p>When we let our minds wander, our thoughts drive us from one idea or emotion to the next,
					...
					are some important differences between the two:</p> <ul><li><b>Intention and Control</b> <p>Mindfulness involves a deliberate choice to stay in the present moment, while mind
							...
							can negatively impact both mental well-being and overall brain function.</p></li></ul></div>`),Q=s(`<div><p>Meditation encompasses a variety of practices used for different purposes across the
					...
					at any moment, not just during meditation.</p></div>`),E=s(`<div><p>Prayer can be thought of as a conversation: expressing gratitude, seeking guidance, or
					asking for something. Mindfulness, on the other hand, involves cultivating awareness of
					the present moment without trying to change it. Rather than asking for anything,
					mindfulness is about being with what is - observing thoughts, emotions, and sensations
					without reacting or getting carried away. Practicing mindfulness can deepen our ability to
					meet life as it unfolds, with greater clarity and acceptance.</p></div>`),J=s(`<div><p>It’s common for tension to build in the body during meditation. Here are some brief
					suggestions for managing body tension during meditation:</p> <ul><li><b>Intentional Breathing Reset</b> <p>Temporarily shift to intentional breathing: gently take full, long breaths with a
							...
							location where there is pain or tension.</p></li></ul></div>`),K=s('<!> <hr class="hr"> <!> <hr class="hr"> <!> <hr class="hr"> <!> <hr class="hr"> <!> <hr class="hr"> <!> <hr class="hr"> <!> <hr class="hr"> <!>',1);function G(I){const $=z([]);A(m=>{var g=F();n(m,g)}),o(I,{get value(){return $},multiple:!0,classes:"opacity-70",children:(m,g)=>{var b=K(),v=T(b);c(v,()=>o.Item,(i,a)=>{a(i,{value:"definition-of-mindfulness",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l("What's the Definition of Mindfulness?");n(e,t)},panel:e=>{var t=S();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})});var y=f(v,4);c(y,()=>o.Item,(i,a)=>{a(i,{value:"what-mindfulness-is-not",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l("What Mindfulness is Not");n(e,t)},panel:e=>{var t=H();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})});var w=f(y,4);c(w,()=>o.Item,(i,a)=>{a(i,{value:"difference-between-focusing-on-a-single-object-in-meditation-and-practicing-open-awareness",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l(`What's the difference between focusing on a single object in meditation and
			practicing open or choiceless awareness?`);n(e,t)},panel:e=>{var t=P();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})});var _=f(w,4);c(_,()=>o.Item,(i,a)=>{a(i,{value:"difference-between-formal-and-informal-mindfulness-practice",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l("What's the difference between formal and informal mindfulness practice?");n(e,t)},panel:e=>{var t=D();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})});var x=f(_,4);c(x,()=>o.Item,(i,a)=>{a(i,{value:"how-does-mindfulness-practice-differ-from-mind-wandering",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l("How Does Mindfulness Practice Differ from Mind Wandering?");n(e,t)},panel:e=>{var t=O();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})});var k=f(x,4);c(k,()=>o.Item,(i,a)=>{a(i,{value:"difference-between-meditation-and-mindfulness-practicce",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l("What's the difference between meditation and mindfulness practice?");n(e,t)},panel:e=>{var t=Q();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})});var M=f(k,4);c(M,()=>o.Item,(i,a)=>{a(i,{value:"difference-between-prayer-and-mindfulness-practice",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l("What's the difference between prayer and mindfulness practice?");n(e,t)},panel:e=>{var t=E();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})});var j=f(M,4);c(j,()=>o.Item,(i,a)=>{a(i,{value:"what-to-do-about-body-tension-during-meditation",lead:e=>{r(e,{size:14})},control:e=>{d();var t=l("What to do about body tension during meditation?");n(e,t)},panel:e=>{var t=J();n(e,t)},$$slots:{lead:!0,control:!0,panel:!0}})}),n(m,b)},$$slots:{default:!0}})}export{G as component,Z as universal};
