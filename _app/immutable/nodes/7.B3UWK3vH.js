import{d as l}from"../chunks/index.3bNkfwDp.js";import{s as d,a as e,t,b as c}from"../chunks/disclose-version.CQ0KEv_e.js";import{i as h,p as u}from"../chunks/stores.3s7bxUGm.js";import{p as m,a as p,$ as f,J as g}from"../chunks/utils.CXtZwj9T.js";import{h as b}from"../chunks/svelte-head.us5l7Pdr.js";const y=l,w=!0,_=Object.freeze(Object.defineProperty({__proto__:null,csr:y,prerender:w},Symbol.toStringTag,{value:"Module"}));var v=t('<meta name="description" content="Mindfulness Questions and Answers">'),M=t(`<details class="svelte-1c964t7"><summary class="svelte-1c964t7">What is the difference between formal and informal mindfulness practice?</summary> <div class="svelte-1c964t7"><p>Formal mindfulness practice involves intentionally setting aside time and space to focus on a
			...
			differences between the two:</p> <ul><li><b>Intention and Control</b> <p>Mindfulness involves a deliberate choice to stay in the present moment, while
					...
					lost in mind-wandering.</p></li></ul></div></details> <details class="svelte-1c964t7"><summary class="svelte-1c964t7">Feeling body tension during meditation</summary> <div class="svelte-1c964t7"><p>It’s common for tension to build in the body during meditation. Here are some brief
			suggestions for managing body tension during meditation:</p> <ul><li><b>Intentional Breathing Reset</b> <p>Temporarily shift to intentional breathing: gently take full, long breaths with a longer
					...
					location where there is pain or tension.</p></li></ul></div></details>`,1);function $(n,i){m(i,!1);const s=d();console.log("mindfulness-questions-and-answers page path: "+c(u,"$page",s).url.pathname),h();var a=M();b(o=>{var r=v();f.title="Mindfulness Questions and Answers",e(o,r)}),g(6),e(n,a),p()}export{$ as component,_ as universal};
